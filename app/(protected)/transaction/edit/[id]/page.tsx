...
export default function EditTransaction() {
  ...
  <CardContent className="space-y-5">
    <h2 className="text-2xl font-bold text-center mb-4">Chỉnh sửa Transaction</h2>
    ...
    {component && (
      <div className="p-4 border rounded bg-gray-50 mt-2 space-y-1">
        <p className="font-semibold text-lg">{component.name} ({component.type})</p>
        ...
        <p>Ngày tạo: {new Date(component.createdAt).toLocaleDateString("vi-VN")}</p>
    ...
    <div className="mt-4">
      ...
      <select
        ...
        value={project?.id ?? ""}
        onChange={(e) => {
          const selected = projects.find((p) => p.id === Number(e.target.value)) || null;
          setProject(selected);
        }}
      >
    ...
    <Button onClick={handleSubmit} className="mt-6 w-full bg-green-600 text-white hover:bg-green-700">
